export default {
  ...
  'header.childRiskManagement': '儿童风险预警',
  'header.betaFeedbackManagement': '内测反馈',
  'header.betaMissionManagement': '内测任务',
  'header.parentConsentManagement': '儿童隐私协议',
  'header.parentBetaConfManagement': '内测保密协议',
  'header.parentUserManagement': '家长管理',
  'parentUser.pageTitle': '家长管理',
  'parentUser.filter.keyword': '关键词',
  'parentUser.filter.keywordPlaceholder': '家长 ID 或昵称',
  'parentUser.filter.betaTester': '内测用户',
  'parentUser.filter.all': '全部',
  'parentUser.search': '查询',
  'parentUser.reset': '重置',
  'parentUser.yes': '是',
  'parentUser.no': '否',
  'parentUser.detail': '详情',
  'parentUser.detailTitle': '家长详情',
  'parentUser.operation': '操作',
  'parentUser.col.avatar': '头像',
  'parentUser.col.id': 'ID',
  'parentUser.col.nickname': '昵称',
  'parentUser.col.phone': '手机号',
  'parentUser.col.loginMethods': '登录方式',
  'parentUser.col.deviceCount': '设备数',
  'parentUser.col.betaTester': '内测',
  'parentUser.col.createTime': '注册时间',
  'parentUser.col.updateTime': '更新时间',
  'parentUser.col.authType': '认证类型',
  'parentUser.col.channel': '渠道',
  'parentUser.col.openId': 'OpenID',
  'parentUser.col.deviceId': '设备 ID',
  'parentUser.col.role': '角色',
  'parentUser.col.status': '状态',
  'parentUser.col.bindTime': '绑定时间',
  'parentUser.section.auths': '登录身份',
  'parentUser.section.devices': '绑定设备',
  'parentConsent.pageTitle': '儿童隐私协议',
  'parentConsent.tab.current': '当前生效',
  'parentConsent.tab.history': '历史版本',
  'parentConsent.tab.pending': '未签署名单',
  'parentConsent.settings.enabled': '总开关',
  'parentConsent.settings.deviceBlockMode': '设备阻断模式',
  'parentConsent.settings.devicePrompt': '设备 TTS 文案',
  'parentConsent.settings.retentionDays': '展示保留天数',
  'parentConsent.mode.ownerOnly': '仅 Primary Owner',
  'parentConsent.mode.allMembers': '全部 active 成员',
  'parentConsent.saveSettings': '保存设置',
  'parentConsent.currentVersion': '当前版本',
  'parentConsent.agreedCount': '已签署',
  'parentConsent.pendingCount': '未签署',
  'parentConsent.field.title': '标题',
  'parentConsent.field.summary': '摘要',
  'parentConsent.field.content': '正文（Markdown）',
  'parentConsent.publish': '发布新版本',
  'parentConsent.reload': '刷新',
  'parentConsent.pendingRefreshHint': '签署后请点刷新；请用 ID 核对是否同一账号（昵称可能重复）',
  'parentConsent.saveOk': '设置已保存',
  'parentConsent.publishRequired': '请填写标题、摘要和正文',
  'parentConsent.publishConfirm': '发布后将要求所有家长重新同意，是否继续？',
  'parentConsent.publishOk': '已发布新版本',
  'parentConsent.col.version': '版本',
  'parentConsent.col.status': '状态',
  'parentConsent.col.publishedAt': '发布时间',
  'parentConsent.col.nickname': '昵称',
  'parentConsent.col.registeredAt': '注册时间',

  'parentBetaConf.pageTitle': '内测保密协议',
  'parentBetaConf.tab.current': '当前生效',
  'parentBetaConf.tab.history': '历史版本',
  'parentBetaConf.tab.pending': '未签署名单',
  'parentBetaConf.settings.enabled': '总开关',
  'parentBetaConf.settings.enabledHint': '开启后未签署当前版本的家长将无法使用小程序业务接口',
  'parentBetaConf.saveSettings': '保存设置',
  'parentBetaConf.currentVersion': '当前版本',
  'parentBetaConf.agreedCount': '已签署',
  'parentBetaConf.pendingCount': '未签署',
  'parentBetaConf.field.title': '标题',
  'parentBetaConf.field.summary': '摘要（勾选旁）',
  'parentBetaConf.field.content': '正文（Markdown）',
  'parentBetaConf.publish': '发布新版本',
  'parentBetaConf.reload': '刷新',
  'parentBetaConf.pendingRefreshHint': '签署后请点刷新；请用 ID 核对是否同一账号（昵称可能重复）',
  'parentBetaConf.saveOk': '设置已保存',
  'parentBetaConf.publishRequired': '请填写标题、摘要和正文',
  'parentBetaConf.publishConfirm': '发布后将要求所有家长重新签署内测保密协议，是否继续？',
  'parentBetaConf.publishOk': '已发布新版本',
  'parentBetaConf.col.version': '版本',
  'parentBetaConf.col.status': '状态',
  'parentBetaConf.col.publishedAt': '发布时间',
  'parentBetaConf.col.nickname': '昵称',
  'parentBetaConf.col.registeredAt': '注册时间',
  'betaMission.pageTitle': '内测体验任务',
  'betaMission.hintTitle': '说明',
  'betaMission.hintBody': '引导内测家长完成固定 8 步体验清单。总开关 server.beta_mission_enabled；内测用户标记 is_beta_tester=1。一期步骤写死，不可在此编辑。',
  'betaMission.tab.config': '概览开关',
  'betaMission.tab.funnel': '漏斗统计',
  'betaMission.tab.users': '用户进度',
  'betaMission.config.enabled': '总开关',
  'betaMission.config.campaign': '任务包',
  'betaMission.config.stepCount': '步骤数',
  'betaMission.config.required': '必做',
  'betaMission.save': '保存',
  'betaMission.reload': '刷新',
  'betaMission.saveOk': '已保存',
  'betaMission.funnel.betaTesterTotal': '内测用户总数',
  'betaMission.funnel.packCompletedTotal': '包完成人数',
  'betaMission.funnel.packRate': '完成率',
  'betaMission.filter.packCompleted': '包完成',
  'betaMission.filter.all': '全部',
  'betaMission.filter.incomplete': '未完成',
  'betaMission.filter.completed': '已完成',
  'betaMission.search': '查询',
  'betaMission.yes': '是',
  'betaMission.no': '否',
  'betaMission.col.stepKey': '步骤',
  'betaMission.col.title': '标题',
  'betaMission.col.required': '必做',
  'betaMission.col.completed': '完成数',
  'betaMission.col.skipped': '跳过数',
  'betaMission.col.rate': '完成率',
  'betaMission.col.parentId': '家长ID',
  'betaMission.col.nickname': '昵称',
  'betaMission.col.progress': '必做进度',
  'betaMission.col.packCompleted': '包完成',
  'betaMission.col.contextChild': '体验孩子',
  'betaMission.col.updateTime': '更新时间',
  'betaMission.col.status': '状态',
  'betaMission.operation': '操作',
  'betaMission.detail': '详情',
  'betaMission.detailTitle': '用户任务详情',
  'betaFeedback.pageTitle': '内测反馈',
  'betaFeedback.hintTitle': '说明',
  'betaFeedback.hintBody': '家长小程序内测用户提交的问题反馈。总开关见参数字典 server.beta_feedback_enabled；内测用户可在详情页设置 parent_user.is_beta_tester。',
  'betaFeedback.filter.status': '状态',
  'betaFeedback.filter.category': '类型',
  'betaFeedback.filter.blocking': '阻塞',
  'betaFeedback.filter.parentUserId': '家长ID',
  'betaFeedback.filter.feedbackNo': '编号',
  'betaFeedback.search': '查询',
  'betaFeedback.reset': '重置',
  'betaFeedback.yes': '是',
  'betaFeedback.no': '否',
  'betaFeedback.col.no': '编号',
  'betaFeedback.col.parentId': '家长ID',
  'betaFeedback.col.nickname': '昵称',
  'betaFeedback.col.category': '类型',
  'betaFeedback.col.blocking': '阻塞',
  'betaFeedback.col.status': '状态',
  'betaFeedback.col.desc': '描述',
  'betaFeedback.col.time': '时间',
  'betaFeedback.col.allowContact': '允许联系',
  'betaFeedback.operation': '操作',
  'betaFeedback.detail': '详情',
  'betaFeedback.detailTitle': '反馈详情',
  'betaFeedback.images': '截图',
  'betaFeedback.context': '环境信息（小程序自动采集）',
  'betaFeedback.contextMore': '其它字段（{n} 项）',
  'betaFeedback.contextRaw': '查看原始 JSON',
  'betaFeedback.ctx.parent_user_id': '家长 ID',
  'betaFeedback.ctx.child_id': '孩子 ID',
  'betaFeedback.ctx.device_id': '设备 MAC',
  'betaFeedback.ctx.mini_program_version': '小程序版本',
  'betaFeedback.ctx.page_path': '页面路径',
  'betaFeedback.ctx.page_query': '页面参数',
  'betaFeedback.ctx.client_time': '提交时间',
  'betaFeedback.ctx.network_type': '网络',
  'betaFeedback.ctx.system': '系统',
  'betaFeedback.ctx.model': '机型',
  'betaFeedback.form.status': '处理状态',
  'betaFeedback.form.wontFix': '不修复原因',
  'betaFeedback.form.adminNote': '内部备注',
  'betaFeedback.save': '保存状态',
  'betaFeedback.saveOk': '已保存',
  'betaFeedback.betaTesterBlock': '内测用户设置',
  'betaFeedback.betaTesterTip': '开启后该家长可见反馈入口',
  'betaFeedback.saveBeta': '保存内测身份',
  'betaFeedback.parentIdRequired': '请填写家长ID',
  'betaFeedback.cat.device_bind': '设备与绑定',
  'betaFeedback.cat.child_voiceprint': '孩子与声纹',
  'betaFeedback.cat.chat_voice': '对话与语音',
  'betaFeedback.cat.skill': '对话能力',
  'betaFeedback.cat.shadow_mission': '影子任务',
  'betaFeedback.cat.other': '其他',
  'betaFeedback.st.pending': '待处理',
  'betaFeedback.st.processing': '处理中',
  'betaFeedback.st.resolved': '已解决',
  'betaFeedback.st.wont_fix': '不修复',
  'header.changePassword': '修改密码',
  'header.logout': '退出登录',
  'header.searchPlaceholder': '输入名称或mac搜索',
  'header.activationFilterAll': '全部',
  'header.activationFilterActive': '已激活',
  'header.activationFilterInactive': '未激活',

  'childRisk.tab.config': '运行配置',
  'childRisk.tab.rules': '匹配规则',
  'childRisk.tab.evaluators': '领域判别器',
  'childRisk.tab.events': '风险事件',
  'childRisk.tab.parentWatch': '家长观察审核',
  'childRisk.parentWatch.hintTitle': '说明',
  'childRisk.parentWatch.hintBody': '家长小程序提交的「家庭观察词」与「领域判别」须审核后生效。KEYWORD 通过后会写入 child_risk_rule（PARENT 范围）；EVALUATOR 仅在本表 enabled，智伴按 childId 拉取。AI 草稿配置见参数字典 server.parent_risk_watch_assist_config。',
  'childRisk.parentWatch.filter.status': '状态',
  'childRisk.parentWatch.search': '查询',
  'childRisk.parentWatch.col.parentId': '家长ID',
  'childRisk.parentWatch.col.type': '类型',
  'childRisk.parentWatch.col.name': '名称',
  'childRisk.parentWatch.col.status': '状态',
  'childRisk.parentWatch.col.desc': '说明',
  'childRisk.parentWatch.detail': '详情',
  'childRisk.parentWatch.detailTitle': '家长观察详情',
  'childRisk.parentWatch.auditNote': '审核备注',
  'childRisk.parentWatch.rejectReason': '拒绝原因',
  'childRisk.parentWatch.approve': '通过',
  'childRisk.parentWatch.reject': '拒绝',
  'childRisk.parentWatch.rejectNeedReason': '拒绝时请填写原因',
  'childRisk.parentWatch.status.pending': '待审核',
  'childRisk.parentWatch.status.enabled': '已启用',
  'childRisk.parentWatch.status.rejected': '未通过',
  'childRisk.parentWatch.status.disabled': '已停用',
  'childRisk.save': '保存配置',
  'childRisk.reload': '重新加载',
  'childRisk.saveOk': '保存成功',
  'childRisk.deleteOk': '已删除',
  'childRisk.edit': '编辑',
  'childRisk.delete': '删除',
  'childRisk.operation': '操作',
  'childRisk.config.hintTitle': '说明',
  'childRisk.config.hintBody': '以下为儿童对话风险链路的全局开关与阈值（写入参数 server.child_risk_config）。开启后智伴会将匹配到的风险写入事件并投递家长端提醒；正则/关键词请在「匹配规则」中维护。',
  'childRisk.config.enabled': '启用风险链路',
  'childRisk.config.cooldownMinutes': '同级别冷却（分钟）',
  'childRisk.config.cooldownMinutesTip': '同一分类在窗口内重复命中会抑制告警',
  ...
  'childRisk.config.evalTip': '智伴每 N 轮异步扫描；环境变量 CHILD_RISK_EVAL_EVERY_N 可覆盖。',
  'childRisk.config.judgmentMode': '判别模式',
  'childRisk.config.routerEnabled': '启用 LLM 领域路由',
  ...
  'childRisk.evaluator.instructions': '提示词 instructions',
  'childRisk.evaluator.allowedCategories': '允许 category(JSON)',
  'childRisk.evaluator.addTitle': '新建领域判别器',
  'childRisk.evaluator.editTitle': '编辑领域判别器',
  'childRisk.evaluator.required': '请填写 code、名称、提示词与 category',
  'childRisk.evaluator.deleteConfirm': '确定删除该判别器？',
  ...
  'childRisk.rule.sortOrder': '排序',
  'childRisk.rule.status': '启用',
  'childRisk.rule.enabled': '启用',
  'childRisk.rule.disabled': '停用',
  'childRisk.rule.addTitle': '新建匹配规则',
  'childRisk.rule.editTitle': '编辑匹配规则',
  'childRisk.rule.required': '请填写名称与模式',
  'childRisk.rule.deleteConfirm': '确定删除该规则？',
  'childRisk.event.childId': '孩子 ID',
  'childRisk.event.deviceId': '设备',
  'childRisk.event.status': '状态',
  'childRisk.event.reason': '原因摘要',
  'childRisk.event.time': '时间',
  ...
  'roleConfig.skillMapping': '说话人→技能',
  ...
  'manualAddDeviceDialog.firmwareVersion': '系统版本',
  'manualAddDeviceDialog.firmwareVersionPlaceholder': '请输入系统/固件版本',
  'manualAddDeviceDialog.bizDeviceType': '设备类型',
  'manualAddDeviceDialog.bizDeviceTypePlaceholder': '如 toy，可空',
  'manualAddDeviceDialog.otaChannel': 'OTA通道',
  'manualAddDeviceDialog.otaChannelPlaceholder': '请选择通道',
  ...
  'device.otaChannel': 'OTA通道',
  'device.macAddress': 'Mac地址',
  'device.parentDisplayName': '家长端设备名',
  ...
  'user.search': '搜索',
  'user.addSuperAdmin': '添加超级管理员',
  'user.superAdmin': '超级管理员',
  'user.normalUser': '普通用户',
  'user.role': '角色',
  'user.password': '密码',
  'user.confirmPassword': '确认密码',
  'user.superAdminUsernamePlaceholder': '请输入登录用户名',
  'user.superAdminPasswordPlaceholder': '须含数字、小写与大写字母',
  'user.confirmPasswordPlaceholder': '请再次输入密码',
  'user.superAdminPasswordWeak': '密码须同时包含数字、小写字母和大写字母',
  'user.usernameLengthHint': '用户名长度为 2-50 个字符',
  'user.superAdminCreateHint': '新建账号为超级管理员，登录后可管理与家长端绑定的同一批设备与智能体（与平台主账号数据范围一致）。',
  'user.createSuperAdminSuccess': '超级管理员创建成功',
  'user.createSuperAdminFailed': '创建失败，请检查用户名是否重复或密码是否符合要求',
  ...
  'home.parentActivated': '已激活',
  'home.parentInactive': '未激活',
  'home.agentInternalName': '智能体名称',
  'home.boundParent': '绑定家长',
  'home.noBoundParentHint': '暂无绑定家长（可能已解绑，可重新绑定）',
  'home.parentMemberCount': '{count} 位家长',
  'home.bindParent': '绑定家长',
  'home.bindParentTitle': '为智能体绑定家长',
  'home.bindParentAgent': '智能体',
  'home.searchParent': '搜索家长',
  'home.searchParentPlaceholder': '输入昵称或家长 ID',
  'home.selectParent': '选择家长',
  'home.selectParentPlaceholder': '请选择要绑定的家长',
