export default {
  ...
  'manualAddDeviceDialog.firmwareVersion': '系統版本',
  'manualAddDeviceDialog.firmwareVersionPlaceholder': '請輸入系統/固件版本',
  'manualAddDeviceDialog.bizDeviceType': '設備類型',
  'manualAddDeviceDialog.bizDeviceTypePlaceholder': '如 toy，可空',
  'manualAddDeviceDialog.otaChannel': 'OTA通道',
  'manualAddDeviceDialog.otaChannelPlaceholder': '請選擇通道',
  ...
  'device.systemVersion': '系統版本',
  'device.appVersion': '應用版本',
  ...
  'home.enableChatHistory': '請在「配置角色」頁面開啟聊天記錄上報',
  'home.enableChatHistory': '請在「配置角色」頁面開啟聊天記錄上報（選「上報文字」或「上報文字+語音」）',
