...
public final class MindStateEngine {

    private MindStateEngine() {
    }

    /**
     * 点亮状态：以证据条数为主（与前端进度条一致），strength 仅用于「积极信号」的质量加成。
     */
    ...
    public static void applyVisualHierarchy(
        ...
        for (MpTemplateNodeEntity tn : sorted) {
            ...
            MpTemplateNodeEntity parent = tn.getParentCode() != null ? nodeByCode.get(tn.getParentCode()) : null;
