export default {
  ...
  'manualAddDeviceDialog.firmwareVersion': 'Phiên bản hệ thống',
  'manualAddDeviceDialog.firmwareVersionPlaceholder': 'Vui lòng nhập phiên bản hệ thống/firmware',
  'manualAddDeviceDialog.bizDeviceType': 'Loại thiết bị',
  'manualAddDeviceDialog.bizDeviceTypePlaceholder': 'vd. toy, tùy chọn',
  'manualAddDeviceDialog.otaChannel': 'Kênh OTA',
  'manualAddDeviceDialog.otaChannelPlaceholder': 'Vui lòng chọn kênh',
  ...
  'device.systemVersion': 'Phiên bản hệ thống',
  'device.appVersion': 'Phiên bản ứng dụng',
  'device.otaChannel': 'Kênh OTA',
