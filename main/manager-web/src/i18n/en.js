export default {
  ...
  'header.skillManagement': 'Skill Management',
  'header.childRiskManagement': 'Child Risk Alerts',
  'header.betaFeedbackManagement': 'Beta Feedback',
  'header.betaMissionManagement': 'Beta Mission',
  'header.parentUserManagement': 'Parent Users',
  'parentUser.pageTitle': 'Parent Users',
  'parentUser.filter.keyword': 'Keyword',
  'parentUser.filter.keywordPlaceholder': 'Parent ID or nickname',
  'parentUser.filter.betaTester': 'Beta tester',
  'parentUser.filter.all': 'All',
  'parentUser.search': 'Search',
  'parentUser.reset': 'Reset',
  'parentUser.yes': 'Yes',
  'parentUser.no': 'No',
  'parentUser.detail': 'Detail',
  'parentUser.detailTitle': 'Parent detail',
  'parentUser.operation': 'Actions',
  'parentUser.col.avatar': 'Avatar',
  'parentUser.col.id': 'ID',
  'parentUser.col.nickname': 'Nickname',
  'parentUser.col.phone': 'Phone',
  'parentUser.col.loginMethods': 'Login methods',
  'parentUser.col.deviceCount': 'Devices',
  'parentUser.col.betaTester': 'Beta',
  'parentUser.col.createTime': 'Registered',
  'parentUser.col.updateTime': 'Updated',
  'parentUser.col.authType': 'Auth type',
  'parentUser.col.channel': 'Channel',
  'parentUser.col.openId': 'OpenID',
  'parentUser.col.deviceId': 'Device ID',
  'parentUser.col.role': 'Role',
  'parentUser.col.status': 'Status',
  'parentUser.col.bindTime': 'Bound at',
  'parentUser.section.auths': 'Login identities',
  'parentUser.section.devices': 'Bound devices',
  'betaMission.pageTitle': 'Beta Experience Mission',
  'betaMission.hintTitle': 'About',
  'betaMission.hintBody': 'Fixed 8-step checklist for beta testers. Toggle server.beta_mission_enabled; users need is_beta_tester=1. Steps are hard-coded in v1.',
  'betaMission.tab.config': 'Config',
  'betaMission.tab.funnel': 'Funnel',
  'betaMission.tab.users': 'Users',
  'betaMission.config.enabled': 'Enabled',
  'betaMission.config.campaign': 'Campaign',
  'betaMission.config.stepCount': 'Steps',
  'betaMission.config.required': 'Required',
  'betaMission.save': 'Save',
  'betaMission.reload': 'Reload',
  'betaMission.saveOk': 'Saved',
  'betaMission.funnel.betaTesterTotal': 'Beta testers',
  'betaMission.funnel.packCompletedTotal': 'Pack completed',
  'betaMission.funnel.packRate': 'Completion rate',
  'betaMission.filter.packCompleted': 'Pack done',
  'betaMission.filter.all': 'All',
  'betaMission.filter.incomplete': 'Incomplete',
  'betaMission.filter.completed': 'Completed',
  'betaMission.search': 'Search',
  'betaMission.yes': 'Yes',
  'betaMission.no': 'No',
  'betaMission.col.stepKey': 'Step',
  'betaMission.col.title': 'Title',
  'betaMission.col.required': 'Required',
  'betaMission.col.completed': 'Completed',
  'betaMission.col.skipped': 'Skipped',
  'betaMission.col.rate': 'Rate',
  'betaMission.col.parentId': 'Parent ID',
  'betaMission.col.nickname': 'Nickname',
  'betaMission.col.progress': 'Required progress',
  'betaMission.col.packCompleted': 'Pack done',
  'betaMission.col.contextChild': 'Context child',
  'betaMission.col.updateTime': 'Updated',
  'betaMission.col.status': 'Status',
  'betaMission.operation': 'Actions',
  'betaMission.detail': 'Detail',
  'betaMission.detailTitle': 'User mission detail',
  'betaFeedback.pageTitle': 'Beta Feedback',
  'betaFeedback.hintTitle': 'About',
  'betaFeedback.hintBody': 'Feedback from beta testers in the parent mini program. Toggle server.beta_feedback_enabled in params; mark users as beta in detail dialog.',
  'betaFeedback.filter.status': 'Status',
  'betaFeedback.filter.category': 'Category',
  'betaFeedback.filter.blocking': 'Blocking',
  'betaFeedback.filter.parentUserId': 'Parent ID',
  'betaFeedback.filter.feedbackNo': 'No.',
  'betaFeedback.search': 'Search',
  'betaFeedback.reset': 'Reset',
  'betaFeedback.yes': 'Yes',
  'betaFeedback.no': 'No',
  'betaFeedback.col.no': 'No.',
  'betaFeedback.col.parentId': 'Parent ID',
  'betaFeedback.col.nickname': 'Nickname',
  'betaFeedback.col.category': 'Category',
  'betaFeedback.col.blocking': 'Blocking',
  'betaFeedback.col.status': 'Status',
  'betaFeedback.col.desc': 'Description',
  'betaFeedback.col.time': 'Time',
  'betaFeedback.col.allowContact': 'Allow contact',
  'betaFeedback.operation': 'Actions',
  'betaFeedback.detail': 'Detail',
  'betaFeedback.detailTitle': 'Feedback detail',
  'betaFeedback.images': 'Screenshots',
  'betaFeedback.context': 'Environment (from mini program)',
  'betaFeedback.contextMore': 'Other fields ({n})',
  'betaFeedback.contextRaw': 'View raw JSON',
  'betaFeedback.ctx.parent_user_id': 'Parent ID',
  'betaFeedback.ctx.child_id': 'Child ID',
  'betaFeedback.ctx.device_id': 'Device MAC',
  'betaFeedback.ctx.mini_program_version': 'Mini program version',
  'betaFeedback.ctx.page_path': 'Page path',
  'betaFeedback.ctx.page_query': 'Page query',
  'betaFeedback.ctx.client_time': 'Client time',
  'betaFeedback.ctx.network_type': 'Network',
  'betaFeedback.ctx.system': 'OS',
  'betaFeedback.ctx.model': 'Device model',
  'betaFeedback.form.status': 'Status',
  'betaFeedback.form.wontFix': "Won't fix reason",
  'betaFeedback.form.adminNote': 'Internal note',
  'betaFeedback.save': 'Save status',
  'betaFeedback.saveOk': 'Saved',
  'betaFeedback.betaTesterBlock': 'Beta tester',
  'betaFeedback.betaTesterTip': 'User can see feedback entry when on',
  'betaFeedback.saveBeta': 'Save beta flag',
  'betaFeedback.parentIdRequired': 'Parent ID required',
  'betaFeedback.cat.device_bind': 'Device & bind',
  'betaFeedback.cat.child_voiceprint': 'Child & voiceprint',
  'betaFeedback.cat.chat_voice': 'Chat & voice',
  'betaFeedback.cat.skill': 'Skills',
  'betaFeedback.cat.shadow_mission': 'Shadow missions',
  'betaFeedback.cat.other': 'Other',
  'betaFeedback.st.pending': 'Pending',
  'betaFeedback.st.processing': 'Processing',
  'betaFeedback.st.resolved': 'Resolved',
  'betaFeedback.st.wont_fix': "Won't fix",
  'header.changePassword': 'Change Password',
  'header.logout': 'Logout',
  'header.searchPlaceholder': 'Search name or mac',
  'header.activationFilterAll': 'All',
  'header.activationFilterActive': 'Active',
  'header.activationFilterInactive': 'Inactive',

  'childRisk.tab.config': 'Settings',
  'childRisk.tab.rules': 'Rules',
  'childRisk.tab.evaluators': 'Evaluators',
  'childRisk.tab.events': 'Events',
  'childRisk.tab.parentWatch': 'Parent watches',
  'childRisk.parentWatch.hintTitle': 'Note',
  'childRisk.parentWatch.hintBody': 'Family keywords and domain evaluators from the parent mini program require approval. KEYWORD entries become PARENT-scoped child_risk_rule rows; EVALUATOR rows stay enabled on this list and are fetched per childId by zhiban-agent.',
  'childRisk.parentWatch.filter.status': 'Status',
  'childRisk.parentWatch.search': 'Search',
  'childRisk.parentWatch.col.parentId': 'Parent ID',
  'childRisk.parentWatch.col.type': 'Type',
  'childRisk.parentWatch.col.name': 'Name',
  'childRisk.parentWatch.col.status': 'Status',
  'childRisk.parentWatch.col.desc': 'Description',
  'childRisk.parentWatch.detail': 'Detail',
  'childRisk.parentWatch.detailTitle': 'Parent watch detail',
  'childRisk.parentWatch.auditNote': 'Audit note',
  'childRisk.parentWatch.rejectReason': 'Reject reason',
  'childRisk.parentWatch.approve': 'Approve',
  'childRisk.parentWatch.reject': 'Reject',
  'childRisk.parentWatch.rejectNeedReason': 'Reject reason is required',
  'childRisk.parentWatch.status.pending': 'Pending',
  'childRisk.parentWatch.status.enabled': 'Enabled',
  'childRisk.parentWatch.status.rejected': 'Rejected',
  'childRisk.parentWatch.status.disabled': 'Disabled',
  'childRisk.save': 'Save',
  'childRisk.reload': 'Reload',
  'childRisk.saveOk': 'Saved',
  'childRisk.deleteOk': 'Deleted',
  'childRisk.edit': 'Edit',
  'childRisk.delete': 'Delete',
  'childRisk.operation': 'Actions',
  'childRisk.config.hintTitle': 'About',
  'childRisk.config.hintBody': 'These values are stored in sys param server.child_risk_config. When enabled, the agent reports matched risks; parents can be notified. Edit keyword/regex rules in the Rules tab.',
  'childRisk.config.enabled': 'Enable risk pipeline',
  'childRisk.config.cooldownMinutes': 'Cooldown (minutes)',
  'childRisk.config.cooldownMinutesTip': 'Same category events are deduplicated within this window',
  ...
  'childRisk.config.evalTip': 'zhiban scans every N rounds; env CHILD_RISK_EVAL_EVERY_N overrides.',
  'childRisk.config.judgmentMode': 'Judgment mode',
  'childRisk.config.routerEnabled': 'LLM domain router',
  ...
  'childRisk.evaluator.instructions': 'Instructions (prompt)',
  'childRisk.evaluator.allowedCategories': 'Allowed categories (JSON)',
  'childRisk.evaluator.addTitle': 'New risk evaluator',
  'childRisk.evaluator.editTitle': 'Edit risk evaluator',
  'childRisk.evaluator.required': 'code, name, instructions and categories required',
  'childRisk.evaluator.deleteConfirm': 'Delete this evaluator?',
  ...
  'childRisk.rule.sortOrder': 'Sort',
  'childRisk.rule.status': 'Status',
  'childRisk.rule.enabled': 'On',
  'childRisk.rule.disabled': 'Off',
  'childRisk.rule.addTitle': 'New rule',
  'childRisk.rule.editTitle': 'Edit rule',
  'childRisk.rule.required': 'Name and pattern are required',
  'childRisk.rule.deleteConfirm': 'Delete this rule?',
  'childRisk.event.childId': 'Child ID',
  'childRisk.event.deviceId': 'Device',
  'childRisk.event.status': 'Status',
  'childRisk.event.reason': 'Reason',
  'childRisk.event.time': 'Time',
  ...
  'roleConfig.skillMapping': 'Speaker→Skill',
  ...
  'manualAddDeviceDialog.firmwareVersion': 'System Version',
  'manualAddDeviceDialog.firmwareVersionPlaceholder': 'Please enter system/firmware version',
  'manualAddDeviceDialog.bizDeviceType': 'Device Type',
  'manualAddDeviceDialog.bizDeviceTypePlaceholder': 'e.g. toy, optional',
  'manualAddDeviceDialog.otaChannel': 'OTA Channel',
  'manualAddDeviceDialog.otaChannelPlaceholder': 'Please select channel',
  ...
  'device.systemVersion': 'System Version',
  'device.appVersion': 'App Version',
  'device.otaChannel': 'OTA Channel',
  'device.macAddress': 'Mac Address',
  'device.parentDisplayName': 'Parent App Device Name',
  ...
  'home.parentActivated': 'Active',
  'home.parentInactive': 'Inactive',
  'home.agentInternalName': 'Agent name',
  'home.boundParent': 'Bound parent',
  'home.noBoundParentHint': 'No bound parent (may have unbound; you can bind again)',
  'home.parentMemberCount': '{count} parents',
  'home.bindParent': 'Bind parent',
  'home.bindParentTitle': 'Bind parent to agent',
  'home.bindParentAgent': 'Agent',
  'home.searchParent': 'Search parent',
  'home.searchParentPlaceholder': 'Nickname or parent ID',
  'home.selectParent': 'Select parent',
  'home.selectParentPlaceholder': 'Choose a parent user',
